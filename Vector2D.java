...
public class Vector2D
{
   ...
   * 
   * A heading of 0 represents a vector pointing directly to the right, the heading increases as
   * vectors are rotated in a counter-clockwise direction.
   * 
   * @param heading
   *          Initial heading
   * @param magnitude
   *          Initial magnitude (length)
   */
  ...
  /**
   * Set the heading of this vector. Note that this operation will have no effect if the magnitude
  ...
  /**
   * @return String representation of this point as "Vector2D[xComponent=x, yComponent=y]"
   */
